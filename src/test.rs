...
/*
TODO: the Thumb mode for ARM now aliases a valid PPC mode, making this test
invalid. Could try MCLASS which *currently* doesn't alias a PPC mode, but this
test is pretty fragile in general and might be rethought.
